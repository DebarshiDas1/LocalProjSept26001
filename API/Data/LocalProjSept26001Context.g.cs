...
namespace LocalProjSept26001.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class LocalProjSept26001Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=LocalProjSept26001Server.database.windows.net;Initial Catalog=T631688_LocalProjSept26001;Persist Security Info=True;user id=lps26001;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
